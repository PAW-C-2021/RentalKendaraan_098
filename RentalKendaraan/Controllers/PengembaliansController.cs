...
namespace RentalKendaraan.Controllers
{
    public class PengembaliansController : Controller
    {
        ...
        {
            var rentalKendaraanContext = _context.Pengembalian.Include(p => p.IdKondisiNavigation).Include(p => p.IdPengembalianNavigation);
        ...
        {
            ViewData["IdKondisi"] = new SelectList(_context.Peminjaman, "IdPeminjaman", "IdPeminjaman");
        ...
        public async Task<IActionResult> Create([Bind("IdPengembalian,TglPengebalian,IdPeminjaman,IdKondisi,Denda")] Pengembalian pengembalian)
        {
            ...
            ViewData["IdKondisi"] = new SelectList(_context.Peminjaman, "IdPeminjaman", "IdPeminjaman", pengembalian.IdKondisi);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPengembalian,TglPengebalian,IdPeminjaman,IdKondisi,Denda")] Pengembalian pengembalian)
        {
